...
SELinux context, enforcement, and status cross-view consistency probe
...
SELINUX_INCONSISTENCY
- Compares raw-syscall and libc reads of the current/previous process contexts and enforcement state.
